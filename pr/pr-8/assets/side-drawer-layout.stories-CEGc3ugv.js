import{i as e}from"./preload-helper-usAeo7Bx.js";import{W as t}from"./iframe-bguXnrg6.js";import{c as n,f as r,l as i,n as a,o,r as s,t as c,u as l}from"./cosmoz-side-panel-BNOVOpgd.js";var u=e((()=>{})),d,f=e((()=>{a(),d=l(class extends i{update(){return this.state.host}})})),p,m=e((()=>{a(),f(),p=e=>{let t=d(),r=o(()=>new CSSStyleSheet,[]);n(()=>{t.shadowRoot.adoptedStyleSheets=[...t.shadowRoot.adoptedStyleSheets,r]},[]),n(()=>{r.replaceSync(e)},[e])}})),h,g,_,v,y=e((()=>{m(),a(),h=(e,t)=>{let n=parseInt(String(e??t),10);return Number.isNaN(n)?t:n},g=`
	.side {
		position: static;
		box-shadow: none;
		z-index: unset;
...
`,_=e=>{let i=h(e.breakpoint,1024);return n(()=>{if(i<=0)return;let t=0,n=new ResizeObserver(n=>{let r=n[0].contentRect.width;r<t&&t>=i&&r<i&&e.dispatchEvent(new CustomEvent(`close`)),t=r});return n.observe(e),()=>n.unobserve(e)},[i]),p(r`
		${i>0?`@container (min-width: ${i}px) {${g}}`:g}
	`),t`
		<div class="wrapper">
...
`,customElements.define(`cosmoz-side-drawer-layout`,s(_,{styleSheets:[v],observedAttributes:[`breakpoint`]}))})),b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F;e((()=>{u(),a(),y(),c(),{fn:b}=__STORYBOOK_MODULE_TEST__,x={title:`SideDrawerLayout`,component:`cosmoz-side-drawer-layout`,tags:[`autodocs`],argTypes:{breakpoint:{control:`number`,description:`Width breakpoint (px) for side/overlay switch. 0 = always side mode.`},side:{control:`select`,options:[`left`,`right`],description:`Which side the drawer opens on.`},drawerOpen:{control:`boolean`,description:`Opens the drawer (overlay mode)`}},args:{breakpoint:1024,side:`left`,drawerOpen:!1,onClose:b()}},S=e=>{e.currentTarget.removeAttribute(`drawer-open`)},C=e=>{let t=e.currentTarget.closest(`.story-app`)?.querySelector(`cosmoz-side-drawer-layout`);t&&t.toggleAttribute(`drawer-open`,!t.hasAttribute(`drawer-open`))},w=(e,t)=>{let n=e.currentTarget.closest(`.story-app`)?.querySelector(t);n&&n.toggleAttribute(`drawer-open`,!n.hasAttribute(`drawer-open`))},T=e=>{let t=e.currentTarget.closest(`.finance-story`);t&&t.classList.add(`is-nav-collapsed`)},E=e=>{let t=e.currentTarget.closest(`.finance-story`);t&&t.classList.remove(`is-nav-collapsed`)},D=e=>{let t=e.currentTarget.closest(`.finance-story`)?.querySelector(`.finance-inner`);t&&t.toggleAttribute(`drawer-open`,!t.hasAttribute(`drawer-open`))},O=e=>{e.currentTarget.removeAttribute(`drawer-open`)},k={render:e=>t`
        <cosmoz-side-drawer-layout
            breakpoint=${e.breakpoint}
            side=${e.side}
            ?drawer-open=${e.drawerOpen}
    ...
    `},A={args:{breakpoint:1600,side:`right`,drawerOpen:!0},render:e=>t`
        <cosmoz-side-drawer-layout
            breakpoint=${e.breakpoint}
            side=${e.side}
            ?drawer-open=${e.drawerOpen}
    ...
    `},j={args:{breakpoint:1600,side:`left`,drawerOpen:!0},render:e=>t`
        <cosmoz-side-drawer-layout
            breakpoint=${e.breakpoint}
            side=${e.side}
            ?drawer-open=${e.drawerOpen}
    ...
    `},M={args:{breakpoint:0,side:`left`,drawerOpen:!0},render:e=>t`
        <cosmoz-side-drawer-layout
            breakpoint=${e.breakpoint}
            side=${e.side}
            ?drawer-open=${e.drawerOpen}
    ...
    `},N={parameters:{layout:`fullscreen`},render:()=>t`
        <style>
            .finance-story {
                position: absolute;
                top: 0;
    ...
    `},P={parameters:{layout:`fullscreen`},render:()=>t`
        <style>
            .pizza-story {
                position: absolute;
                top: 0;
  ...
  render: () => html\`
                        ...
                        <section class="pizza-hero">
                            ...
                            <div class="pizza-actions">
                                <button
                                    class="pizza-button-secondary"
                                    type="button"
                                    @click=\${(event: Event) => toggleDrawerInLayout(event, '.pizza-outer')}
                                >
                                    Order menu
                                </button>
                                <button
                                    class="pizza-button"
                                    type="button"
                                    @click=\${(event: Event) => toggleDrawerInLayout(event, '.pizza-inner')}
                                >
                                    Show map
                                </button>
                            </div>
    ...
    \`
}`,...P.parameters?.docs?.source}}},F=[`Default`,`RightDrawer`,`LeftDrawer`,`AlwaysSideMode`,`FinanceDashboard`,`PizzaOrderMap`]}))();export{M as AlwaysSideMode,k as Default,N as FinanceDashboard,j as LeftDrawer,P as PizzaOrderMap,A as RightDrawer,F as __namedExportsOrder,x as default};